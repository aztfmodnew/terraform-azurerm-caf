locals {
  ...
  combined_objects_aks_clusters                                   = merge(tomap({ (local.client_config.landingzone_key) = merge(module.aks_clusters, local.aks_clusters_data_sources_resolved, { for key, value in lookup(var.data_sources, "aks_clusters", {}) : key => value if try(value.id, null) != null }) }), lookup(var.remote_objects, "aks_clusters", {}))
  ...
  combined_objects_application_insights                           = merge(tomap({ (local.client_config.landingzone_key) = merge(module.azurerm_application_insights, local.application_insights_data_sources_resolved, { for key, value in lookup(var.data_sources, "azurerm_application_insights", {}) : key => value if try(value.id, null) != null }) }), lookup(var.remote_objects, "azurerm_application_insights", {}))
  ...
  combined_objects_chaos_studio_targets                           = merge(tomap({ (local.client_config.landingzone_key) = module.chaos_studio_targets }), lookup(var.remote_objects, "chaos_studio_targets", {}))
  combined_objects_chaos_studio_capabilities                      = merge(tomap({ (local.client_config.landingzone_key) = module.chaos_studio_capabilities }), lookup(var.remote_objects, "chaos_studio_capabilities", {}))
  combined_objects_chaos_studio_experiments                       = merge(tomap({ (local.client_config.landingzone_key) = module.chaos_studio_experiments }), lookup(var.remote_objects, "chaos_studio_experiments", {}))
  ...
  combined_objects_azure_bots                                     = merge(tomap({ (local.client_config.landingzone_key) = module.azure_bots }), lookup(var.remote_objects, "azure_bots", {}), lookup(var.data_sources, "azure_bots", {}))
  ...
  combined_objects_container_registry                             = merge(tomap({ (local.client_config.landingzone_key) = merge(module.container_registry, local.container_registry_data_sources_resolved, { for key, value in lookup(var.data_sources, "container_registry", {}) : key => value if try(value.id, null) != null }) }), lookup(var.remote_objects, "container_registry", {}))
  ...
  combined_objects_cosmos_dbs                                     = merge(tomap({ (local.client_config.landingzone_key) = merge(module.cosmos_dbs, local.cosmos_dbs_data_sources_resolved, { for key, value in lookup(var.data_sources, "cosmos_dbs", {}) : key => value if try(value.id, null) != null }) }), lookup(var.remote_objects, "cosmos_dbs", {}))
  ...
  combined_objects_cost_anomaly_alerts                            = merge(tomap({ (local.client_config.landingzone_key) = module.cost_anomaly_alerts }), lookup(var.remote_objects, "cost_anomaly_alerts", {}))
  ...
  combined_objects_managed_redis                                  = merge(tomap({ (local.client_config.landingzone_key) = module.managed_redis }), lookup(var.remote_objects, "managed_redis", {}))
  ...
  combined_objects_digital_twins_endpoint_eventhubs               = merge(tomap({ (local.client_config.landingzone_key) = module.digital_twins_endpoint_eventhub }), lookup(var.remote_objects, "digital_twins_endpoint_eventhubs", {}))
  combined_objects_digital_twins_endpoint_eventgrids              = merge(tomap({ (local.client_config.landingzone_key) = module.digital_twins_endpoint_eventgrid }), lookup(var.remote_objects, "digital_twins_endpoint_eventgrids", {}))
  combined_objects_digital_twins_endpoint_servicebuses            = merge(tomap({ (local.client_config.landingzone_key) = module.digital_twins_endpoint_servicebus }), lookup(var.remote_objects, "digital_twins_endpoint_servicebuses", {}))
  combined_objects_disk_encryption_sets                           = merge(tomap({ (local.client_config.landingzone_key) = merge(module.disk_encryption_sets, module.disk_encryption_sets_external, local.disk_encryption_sets_data_sources_resolved, { for key, value in lookup(var.data_sources, "disk_encryption_sets", {}) : key => value if try(value.id, null) != null }) }), lookup(var.remote_objects, "disk_encryption_sets", {}), lookup(var.remote_objects, "disk_encryption_sets_external", {}))
  combined_objects_dns_zones                                      = merge(tomap({ (local.client_config.landingzone_key) = merge(module.dns_zones, local.dns_zones_data_sources_resolved, { for key, value in lookup(var.data_sources, "dns_zones", {}) : key => value if try(value.id, null) != null }) }), lookup(var.remote_objects, "dns_zones", {}))
  ...
  combined_objects_event_hub_namespaces                           = merge(tomap({ (local.client_config.landingzone_key) = merge(module.event_hub_namespaces, local.event_hub_namespaces_data_sources_resolved, { for key, value in lookup(var.data_sources, "event_hub_namespaces", {}) : key => value if try(value.id, null) != null }) }), lookup(var.remote_objects, "event_hub_namespaces", {}))
  ...
  combined_objects_keyvault_certificate_issuers           = merge(tomap({ (local.client_config.landingzone_key) = module.keyvault_certificate_issuers }), lookup(var.remote_objects, "keyvault_certificate_issuers", {}), lookup(var.data_sources, "keyvault_certificate_issuers", {}))
  ...
  combined_objects_keyvaults                              = merge(tomap({ (local.client_config.landingzone_key) = merge(module.keyvaults, local.keyvaults_data_sources_resolved, { for key, value in lookup(var.data_sources, "keyvaults", {}) : key => value if try(value.id, null) != null }) }), lookup(var.remote_objects, "keyvaults", {}))
  ...
  combined_objects_linux_function_apps                    = merge(tomap({ (local.client_config.landingzone_key) = merge(module.linux_function_apps, lookup(var.data_sources, "linux_function_apps", {})) }), lookup(var.remote_objects, "linux_function_apps", {}))
  combined_objects_linux_web_apps                         = merge(tomap({ (local.client_config.landingzone_key) = module.linux_web_apps }), lookup(var.remote_objects, "linux_web_apps", {}), lookup(var.data_sources, "linux_web_apps", {}))
  ...
  combined_objects_log_analytics                          = merge(tomap({ (local.client_config.landingzone_key) = merge(module.log_analytics, local.log_analytics_data_sources_resolved, { for key, value in lookup(var.data_sources, "log_analytics", {}) : key => value if try(value.id, null) != null }) }), lookup(var.remote_objects, "log_analytics", {}))
  ...
  combined_objects_mssql_servers                                 = merge(tomap({ (local.client_config.landingzone_key) = merge(module.mssql_servers, local.mssql_servers_data_sources_resolved, { for key, value in lookup(var.data_sources, "mssql_servers", {}) : key => value if try(value.id, null) != null }) }), lookup(var.remote_objects, "mssql_servers", {}))
  combined_objects_mysql_flexible_servers                        = merge(tomap({ (local.client_config.landingzone_key) = merge(module.mysql_flexible_servers, local.mysql_flexible_servers_data_sources_resolved, { for key, value in lookup(var.data_sources, "mysql_flexible_servers", {}) : key => value if try(value.id, null) != null }) }), lookup(var.remote_objects, "mysql_flexible_servers", {}))
  ...
  combined_objects_network_manager_admin_rule_collections        = merge(tomap({ (local.client_config.landingzone_key) = module.network_manager_admin_rule_collections }), lookup(var.remote_objects, "network_manager_admin_rule_collections", {}), lookup(var.data_sources, "network_manager_admin_rule_collections", {}))
  combined_objects_network_manager_admin_rules                   = merge(tomap({ (local.client_config.landingzone_key) = module.network_manager_admin_rules }), lookup(var.remote_objects, "network_manager_admin_rules", {}), lookup(var.data_sources, "network_manager_admin_rules", {}))
  combined_objects_network_manager_deployments                   = merge(tomap({ (local.client_config.landingzone_key) = module.network_manager_deployments }), lookup(var.remote_objects, "network_manager_deployments", {}), lookup(var.data_sources, "network_manager_deployments", {}))
  combined_objects_network_manager_connectivity_configurations   = merge(tomap({ (local.client_config.landingzone_key) = module.network_manager_connectivity_configurations }), lookup(var.remote_objects, "network_manager_connectivity_configurations", {}), lookup(var.data_sources, "network_manager_connectivity_configurations", {}))
  combined_objects_network_manager_management_group_connections  = merge(tomap({ (local.client_config.landingzone_key) = module.network_manager_management_group_connections }), lookup(var.remote_objects, "network_manager_management_group_connections", {}), lookup(var.data_sources, "network_manager_management_group_connections", {}))
  combined_objects_network_manager_network_groups                = merge(tomap({ (local.client_config.landingzone_key) = module.network_manager_network_groups }), lookup(var.remote_objects, "network_manager_network_groups", {}), lookup(var.data_sources, "network_manager_network_groups", {}))
  combined_objects_network_manager_scope_connections             = merge(tomap({ (local.client_config.landingzone_key) = module.network_manager_scope_connections }), lookup(var.remote_objects, "network_manager_scope_connections", {}), lookup(var.data_sources, "network_manager_scope_connections", {}))
  combined_objects_network_manager_security_admin_configurations = merge(tomap({ (local.client_config.landingzone_key) = module.network_manager_security_admin_configurations }), lookup(var.remote_objects, "network_manager_security_admin_configurations", {}), lookup(var.data_sources, "network_manager_security_admin_configurations", {}))
  combined_objects_network_manager_static_members                = merge(tomap({ (local.client_config.landingzone_key) = module.network_manager_static_members }), lookup(var.remote_objects, "network_manager_static_members", {}), lookup(var.data_sources, "network_manager_static_members", {}))
  combined_objects_network_manager_subscription_connections      = merge(tomap({ (local.client_config.landingzone_key) = module.network_manager_subscription_connections }), lookup(var.remote_objects, "network_manager_subscription_connections", {}), lookup(var.data_sources, "network_manager_subscription_connections", {}))
  ...
  combined_objects_network_security_perimeters                   = merge(tomap({ (local.client_config.landingzone_key) = module.network_security_perimeters }), lookup(var.remote_objects, "network_security_perimeters", {}))
  ...
  combined_objects_networking                                    = merge(tomap({ (local.client_config.landingzone_key) = merge(module.networking, local.vnets_data_sources_resolved, { for key, value in lookup(var.data_sources, "vnets", {}) : key => value if try(value.id, null) != null }) }), lookup(var.remote_objects, "vnets", {}))
  ...
  combined_objects_service_plans                            = merge(tomap({ (local.client_config.landingzone_key) = merge(module.service_plans, local.service_plans_data_sources_resolved, { for key, value in lookup(var.data_sources, "service_plans", {}) : key => value if try(value.id, null) != null }) }), lookup(var.remote_objects, "service_plans", {}))
  combined_objects_servicebus_namespaces                    = merge(tomap({ (local.client_config.landingzone_key) = merge(module.servicebus_namespaces, local.servicebus_namespaces_data_sources_resolved, { for key, value in lookup(var.data_sources, "servicebus_namespaces", {}) : key => value if try(value.id, null) != null }) }), lookup(var.remote_objects, "servicebus_namespaces", {}))
  ...
  combined_objects_storage_accounts                         = merge(tomap({ (local.client_config.landingzone_key) = merge(module.storage_accounts, local.storage_accounts_data_sources_resolved, { for key, value in lookup(var.data_sources, "storage_accounts", {}) : key => value if try(value.id, null) != null }) }), lookup(var.remote_objects, "storage_accounts", {}))
  ...
  combined_objects_virtual_hubs                             = merge(tomap({ (local.client_config.landingzone_key) = merge(module.virtual_hubs, local.virtual_hubs_data_sources_resolved, { for key, value in lookup(var.data_sources, "virtual_hubs", {}) : key => value if try(value.id, null) != null }) }), lookup(var.remote_objects, "virtual_hubs", {}))
