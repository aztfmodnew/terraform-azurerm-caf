locals {
  ...
  combined_objects_mysql_flexible_servers                        = merge(tomap({ (local.client_config.landingzone_key) = merge(module.mysql_flexible_servers, lookup(var.data_sources, "mysql_flexible_servers", {})) }), lookup(var.remote_objects, "mysql_flexible_servers", {}))
