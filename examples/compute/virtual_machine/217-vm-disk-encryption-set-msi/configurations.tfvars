...
keyvault_access_policies = {
  ...
  kv1 = {
    logged_in_user = {
      ...
      key_permissions    = ["Decrypt", "Encrypt", "Sign", "UnwrapKey", "Verify", "WrapKey", "List", "Get", "Create", "Delete", "Purge", "Recover", "Update", "GetRotationPolicy", "SetRotationPolicy"]
    }
    des_msi = {
      managed_identity_key = "des"
      key_permissions      = ["Decrypt", "Encrypt", "Sign", "UnwrapKey", "Verify", "WrapKey", "List", "Get", "Create", "Delete", "Purge", "Recover", "Update", "GetRotationPolicy", "SetRotationPolicy"]
    }
  }
}
