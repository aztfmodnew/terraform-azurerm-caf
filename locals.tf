...
locals {
  ...
  global_settings = merge({
    ...
    suffixes           = try(var.global_settings.suffixes, null) == "" ? null : try([var.global_settings.suffix], try(var.global_settings.suffixes, try([random_string.suffix[0].result], null)))
