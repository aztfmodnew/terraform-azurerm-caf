...
**ALWAYS create new branches from `main`** — never from an existing feature branch unless explicitly requested.
...
Before starting any new task, verify the branch base:
```bash
git log --oneline main..HEAD  # Should be empty for a fresh branch
```
