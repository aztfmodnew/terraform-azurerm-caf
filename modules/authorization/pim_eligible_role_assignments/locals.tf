locals {
  ...
  scope = coalesce(
    ...
    try(local.eligible_scope_from_management_group_data, null),
    try(local.eligible_scope_from_subscription_data, null)
  )
  ...
  principal_id = coalesce(
    ...
    try(local.eligible_principal_from_managed_identity_data, null),
    try(local.eligible_principal_from_azuread_group_data, null)
  )
}
