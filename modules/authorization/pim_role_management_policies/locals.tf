locals {
  ...
  scope = coalesce(
    ...
    try(local.policy_scope_from_management_group_data, null),
    try(local.policy_scope_from_subscription_data, null)
  )
  ...
  role_definition_id_resolved = coalesce(
    ...
    try(local.policy_role_definition_from_data, null)
  )
