# Hybrid naming system for azurerm_app_service_environment_v3
...
resource "azurecaf_name" "main_resource" {
  ...
  name          = local.base_name
  resource_type = "azurerm_resource_group" # Using temporary workaround as azurerm_app_service_environment_v3 is not supported by azurecaf
