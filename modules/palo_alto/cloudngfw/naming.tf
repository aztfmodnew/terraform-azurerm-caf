# Hybrid naming system for azurerm_palo_alto_next_generation_firewall_virtual_network_local_rulestack
...
resource "azurecaf_name" "main_resource" {
  ...
  name          = local.base_name
  resource_type = "general" # Fallback for unsupported type
