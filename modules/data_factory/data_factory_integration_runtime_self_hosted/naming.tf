# Hybrid naming system for azurerm_data_factory_integration_runtime_self_hosted
...
locals {
  ...
  resource_type = "azurerm_synapse_integration_runtime_self_hosted" # Using supported equivalent type as fallback
