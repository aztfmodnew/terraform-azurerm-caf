# Hybrid naming system for azurerm_data_factory_integration_runtime_azure_ssis
...
locals {
  ...
  resource_type = "azurerm_data_factory_integration_runtime_managed" # Using closest supported type as fallback
