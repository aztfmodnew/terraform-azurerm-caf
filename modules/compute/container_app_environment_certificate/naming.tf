# Hybrid naming system for azurerm_container_app_environment_certificate
...
locals {
  ...
  resource_type = "azurerm_container_app_environment" # Using parent environment type as fallback
