# Hybrid naming system for azurerm_container_app_environment_dapr_component
...
locals {
  ...
  resource_type = "azurerm_container_app" # Using parent container app type as fallback
