# Hybrid naming system for azurerm_virtual_desktop_application
...
locals {
  ...
  resource_type = "azurerm_virtual_desktop_application_group" # Using supported parent type as fallback
