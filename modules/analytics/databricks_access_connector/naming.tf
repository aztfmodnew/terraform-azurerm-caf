# Hybrid naming system for azurerm_databricks_access_connector
...
locals {
  ...
  resource_type = "azurerm_databricks_access_connector"
...
resource "azurecaf_name" "main_resource" {
  ...
  name          = local.base_name
  resource_type = "azurerm_databricks_workspace" # Use closest supported type
